...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hzv-qb4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hzv-qb4.containers.anotherwebservice.com/
...
```
git clone git@github.com:A7med-Hosam/container-hzv-qb4.git
cd container-hzv-qb4
```
...
```
docker attach container-hzv-qb4
```
